    ...
    <div className="da-root">
      ...
      <AnimatePresence mode="wait">
        {!authed ? (
          <motion.div key="login" className="da-login-card"
            ...
            <img src="/assets/airfns-logo.png" alt="AirFns Softwares" className="da-login-logo" />
            <h1 className="da-login-title">Daya Motives</h1>
          ...
          <motion.div key="dash" className="da-dash"
            ...
            <div className="da-header">
              <div className="da-header-left">
                <img src="/assets/airfns-logo.png" alt="AirFns" className="da-dash-logo" />
                <div>
                  <h1 className="da-dash-title">Daya Motives</h1>
      ...
      <style>{`
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .da-login-title { font-size: clamp(22px, 6vw, 28px); font-weight: 800; letter-spacing: -0.02em; margin-bottom: 6px; }
        ...
        .da-dash-title { font-size: clamp(18px, 4vw, 24px); font-weight: 800; letter-spacing: -0.02em; line-height: 1.1; }
